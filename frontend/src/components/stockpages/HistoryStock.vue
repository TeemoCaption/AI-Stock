<template>
  <div>
    <div class="date-form">
      <form class="search" @submit.prevent="fetchStockData">
        <div class="search-bar">
          <label for="start-date">起始日</label>
          <input type="date" id="start-date" v-model="startDate" min="1900-01-01" max="2099-12-31">

          <label for="end-date">結束日</label>
          <input type="date" id="end-date" v-model="endDate" min="1900-01-01" max="2099-12-31">

          <button class="search-button" type="submit"><i class="fa-solid fa-magnifying-glass"></i></button>
          <button class="reset-button" type="reset"><i class="fa-solid fa-rotate-right"></i></button>
        </div>
      </form>
    </div>
    <div class="history-chart" ref="chart"></div>
  </div>
</template>
